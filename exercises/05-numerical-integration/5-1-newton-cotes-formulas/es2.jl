...
function errors(s::Vector{Float64}, exact::Float64, nodes)
    ...
    relative_plots = plot(nodes, make_log_safe(relative_errors), label="Relative errors", yscale=:log10, xscale=:log10)
    xlabel!("Nodes")
