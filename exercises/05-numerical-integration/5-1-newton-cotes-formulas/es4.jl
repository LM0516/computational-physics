...
function main()
  ...
  ap2 = errors(simpson2, exact2, nodes)
  ...
  ap3 = errors(simpson3, exact3, nodes)
  ...
  ap4 = errors(simpson4, exact4, nodes)
  ...
  println("Simpson solution: $(simpson5[end])")
  ap5 = errors(simpson5, exact5, nodes)
  ...
  ap6 = errors(simpson6, exact6, nodes)
